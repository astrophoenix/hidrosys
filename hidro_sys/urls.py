...
urlpatterns = patterns('',
    ...
    url(r'^obtener_mediciones_grafica/$', "hidro_core.views.obtener_mediciones_grafica"),
    url(r'^reporte_grafico/$', "hidro_core.views.reporte_grafico"),
    url(r'^notificaciones/$', "hidro_core.views.notificaciones"),
    url(r'^obtener_notificaciones/$', "hidro_core.views.obtener_notificaciones"),
    url(r'^obtener_todas_notificaciones/$', "hidro_core.views.obtener_todas_notificaciones"),
